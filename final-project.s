...
# Date: 4/28
# this program gets a sentence of length up to 503 char, then gets a char x
# It then prints out the string up to but no farther than the first instance
# of that char x
...
L6:									# end of program an done
	...
	andl	$512, %esp				# Deinitialize the stack
